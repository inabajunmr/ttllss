...
func main() {
	...
	supportedVersionsExtensions := handshake.NewSupportedVersionsForClient(
		[]handshake.ProtocolVersion{handshake.NewProtocolVersion(0x0304)},
	)
	// TODO required extensions for ClientHello
	ch := handshake.NewClientHello(cipherSuites, []handshake.Extension{supportedVersionsExtensions})
